            ...
            <div class="modal-body">
                ...
                <form method="post" action="guest_stays.php">
                    ...
                    <div class="row">
                        <div class="input-group">
                            <label>Booked via <span style="color:#ef4444;">*</span></label>
                            <select name="booked_via" id="addBookedVia" onchange="handleBookedViaChange(this, 'addBookedViaDetailGroup', 'addBookedViaDetailLabel', 'addBookedViaDetail')" required>
                                <option value="">Select Channel</option>
                                <?php foreach ($bookedViaOptions as $opt): ?>
                                    <option value="<?= h($opt); ?>"><?= h($opt); ?></option>
                                <?php endforeach; ?>
                            </select>
                            <div class="input-group" id="addBookedViaDetailGroup" style="display:none; margin-top:8px;">
                                <label id="addBookedViaDetailLabel" style="font-size:12px; font-weight:600; color:#475569;">Agency / Referral Name</label>
                                <input type="text" name="booked_via_detail" id="addBookedViaDetail" placeholder="Enter name">
                            </div>
                        </div>
                        <div class="input-group">
                            <label>Room Plan <span style="color:#ef4444;">*</span></label>
